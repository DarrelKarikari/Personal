        ...
        <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
            ...
            <div>
                ...
                <p className='text-[#283a4d] mb-4 max-w-md'>
                    ...
                    If you would like to reach out for questions or even just to say hi, feel free to shoot me an email with whatever inquiries you may have!
                </p>
                <div className="socials flex flex-row gap-2">
                    <Link href="https://www.github.com/DarrelKarikari" target="_blank">
                        <Image src={github_icon} alt="Github Icon" />
                    </Link>
                    <Link href="https://www.linkedin.com/in/darrelkarikari/" target="_blank">
