        ...
        <section className="flex flex-col items-center justify-center min-h-screen mt-40 relative">
            ...
            <div className="relative z-10 text-center">
                ...
                <p className='text-[#283a4d] mb-8 text-2xl max-w-lg mx-auto'>
                    I am currently seeking internships and other work opportunities for this upcoming Summer Semester!
                    If you would like to reach out to me, for any questions or even just for a quick conversation, feel free to connect with me on my socials!
                </p>
            <div className = "socials flex flex-row gap-4 justify-center">
                <Link href = "https://www.github.com/DarrelKarikari" target="_blank">
                    <Image src={github_icon} alt="Github Icon" width={250} height={250} />
                </Link>
                <Link href="https://www.linkedin.com/in/darrel-karikari/" target="_blank">
